...
const I18N = {
  en: {
    ...
    'pwa.iosInstall': 'Install FindToilet: tap Share, then “Add to Home Screen”.',
    'pwa.update': 'A new version is available.',
    'pwa.refresh': 'Refresh',
    'pwa.download': '⬇︎ Offline',
    'pwa.downloading': 'Downloading…',
  ...
  zh: {
    ...
    'pwa.install': '安装应用',
    'pwa.iosInstall': '安装 FindToilet：点“分享”，然后“添加到主屏幕”。',
    'pwa.update': '发现新版本。',
    'pwa.refresh': '刷新',
    'pwa.download': '⬇︎ 离线',
    'pwa.downloading': '下载中…',
    'pwa.offlineReady': '✓ 已可离线',
    'pwa.dismiss': '关闭',
  },
  es: {
    ...
    'pwa.iosInstall': 'Instala FindToilet: toca Compartir y luego “Añadir a pantalla de inicio”.',
    'pwa.update': 'Hay una nueva versión disponible.',
    'pwa.refresh': 'Actualizar',
    'pwa.download': '⬇︎ Sin conexión',
    'pwa.downloading': 'Descargando…',
    'pwa.offlineReady': '✓ Lista sin conexión',
    'pwa.dismiss': 'Cerrar',
  },
  ja: {
    'nav.contribute': '貢献する',
    ...
    'pwa.iosInstall': 'FindToilet をインストール：共有 →「ホーム画面に追加」。',
    'pwa.update': '新しいバージョンがあります。',
    'pwa.refresh': '更新',
    'pwa.download': '⬇︎ オフライン',
    'pwa.downloading': 'ダウンロード中…',
    'pwa.offlineReady': '✓ オフラインOK',
    'pwa.dismiss': '閉じる',
  },
  ko: {
    'nav.contribute': '기여하기',
    ...
    'pwa.install': '앱 설치',
    'pwa.iosInstall': 'FindToilet 설치: 공유 → “홈 화면에 추가”.',
    'pwa.update': '새 버전이 있습니다.',
    'pwa.refresh': '새로고침',
    'pwa.download': '⬇︎ 오프라인',
    'pwa.downloading': '다운로드 중…',
    'pwa.offlineReady': '✓ 오프라인 준비됨',
    'pwa.dismiss': '닫기',
  },
  fr: {
    ...
    'pwa.iosInstall': 'Installer FindToilet : touchez Partager, puis « Sur l’écran d’accueil ».',
    'pwa.update': 'Une nouvelle version est disponible.',
    'pwa.refresh': 'Actualiser',
    'pwa.download': '⬇︎ Hors ligne',
    'pwa.downloading': 'Téléchargement…',
    'pwa.offlineReady': '✓ Prêt hors ligne',
    'pwa.dismiss': 'Fermer',
  },
};
